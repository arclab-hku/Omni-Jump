...
class AliengoBaseCfg(LeggedRobotCfg):
    ...
    class control(LeggedRobotCfg.control):
        # PD Drive parameters:
        control_type = "actuator_net"#"POSE"#"actuator_net"#"actuator_net"#"POSE"#"actuator_net"#
    ...
    class rewards(LeggedRobotCfg.rewards):
        ...
        class scales(LeggedRobotCfg.rewards.scales):
            tracking_lin_vel = 1.2#1.0#0.6#1.5#1.0
            tracking_ang_vel = 0.#0.5#0.35
            tracking_yaw = 0.6
            ...
            jumping = 1.0#1.0
            has_jumped = 0.#1.0 # remember to delete the has_jumped cutoff in check_termination

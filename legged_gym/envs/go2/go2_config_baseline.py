...
class Go2BaseCfg(LeggedRobotCfg):
    ...
    class init_state(LeggedRobotCfg.init_state):
        ...
        default_joint_angles = { # = target angles [rad] when action = 0.0
            ...
            'FL_hip_joint': -0.05,#0.04,   # [rad]
            'RL_hip_joint': -0.05,#0.04,   # [rad]
            'FR_hip_joint': 0.05,#-0.04,  # [rad]
            'RR_hip_joint': 0.05,#-0.04,   # [rad]

            'FL_thigh_joint': 0.8,#0.722,#0.64,     # [rad]
            'RL_thigh_joint': 1.0,#0.722,#0.69,   # [rad]
            'FR_thigh_joint': 0.8,#0.722,#0.64,     # [rad]
            'RR_thigh_joint': 1.0,#0.722,#0.69,   # [rad]

            'FL_calf_joint': -1.5,#-1.44,   # [rad]
            'RL_calf_joint': -1.5,#-1.44,    # [rad]
            'FR_calf_joint': -1.5,#-1.44,  # [rad]
            'RR_calf_joint': -1.5,#-1.44,    # [rad]
        }

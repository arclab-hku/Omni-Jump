...
class ArcdogBaseCfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        file = "{LEGGED_GYM_ROOT_DIR}/resources/robots/arcdog/urdf/arcdog.urdf"
        name = "arcdog"
        foot_name = "foot"
...
class ArcdogBaseCfgPPO(LeggedRobotCfgPPO):
